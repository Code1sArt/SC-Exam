...
export const codingTestService = {
  ...
  violation: (token: string, attemptId: string, type: string, keepalive = false) => api<CodingAttempt>(`/coding-tests/attempts/${attemptId}/violation`, { ...jsonRequest({ type }), keepalive }, token),
