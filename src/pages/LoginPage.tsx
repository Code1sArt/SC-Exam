...
import bannerImage from "../assets/sc-exam-banner.png";
    ...
    <main className="grid min-h-screen bg-[#f7faf8] lg:grid-cols-[1.08fr_.92fr]">
      <section className="relative hidden min-h-screen overflow-hidden lg:block">
        ...
        <div className="relative flex h-full max-w-xl flex-col p-12 text-white xl:p-16">
          <div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-lg bg-white text-[#176b55]"><GraduationCap size={22} /></span><b className="text-lg">SC Exam</b></div>
          <div className="my-auto max-w-md"><span className="text-xs font-semibold text-[#bde8d9]">LEARNING FOR THE FUTURE</span><h1 className="mt-4 text-4xl font-bold leading-[1.35] xl:text-5xl">SC Exam<br />การศึกษายุคใหม่<br />กับครู (Gen) Y</h1><p className="mt-5 max-w-sm text-sm leading-7 text-white/85">พื้นที่เรียนรู้และทำข้อสอบที่ช่วยให้ทุกก้าวของนักเรียนชัดเจนขึ้น</p></div>
      ...
      <section className="flex min-h-screen flex-col px-6 py-10 sm:px-10">
        <form className="m-auto w-full max-w-sm" onSubmit={submit}>
          <div className="mb-10 lg:hidden"><div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-lg bg-[#176b55] text-white"><GraduationCap size={22} /></span><b className="text-lg text-[#18322d]">SC Exam</b></div><p className="mt-3 text-xs font-semibold leading-5 text-[#237b63]">การศึกษายุคใหม่ กับครู (Gen) Y</p></div>
